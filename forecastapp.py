...
st.set_page_config(page_title ="Forecast Away",initial_sidebar_state="collapsed",page_icon="🔮")
...
code_options = ["Dataframe information","Model fitting","Cross validation","Hyperparameter tuning"]

if page == "Application":
    with st.sidebar:
        if st.button(label='Clear cache'): caching.clear_cache()
    ...
    try:
        if sample:
            st.markdown("""[download_link](https://gist.github.com/rbb-99/e0b5c2d2e71d4fd4388295eb5b71aeeb)""")    
    except:
        if input:
